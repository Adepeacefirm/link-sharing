...
const Navbar = () => {
  ...
  return (
    <header className=" w-[80%] mx-auto my-3 sm:my-7 flex items-center justify-between">
      <div>
        <picture>
          <source
            media="(min-width: 640px)"
            srcSet="/logo-devlinks-large.svg"
          />
          <img
            className="sm:w-[70%]"
      ...
      <nav className="flex items-center sm:mr-10 gap-5">
        <NavLink
          to={"/"}
          className={({ isActive }) =>
            `p-3 rounded-lg sm:flex sm:items-center sm:gap-2 font-medium ${
              isActive ? "text-purple600 bg-grey100" : "text-grey500"
            }`
          }
        >
          <svg
        ...
        <NavLink
          to={"/profile"}
          className={({ isActive }) =>
            `p-3  rounded-lg sm:flex sm:items-center sm:gap-2 ${
              isActive
                ? "text-purple600 bg-grey100 font-medium"
                : "text-grey500"
            }`
          }
        >
          ...
          <span className="hidden sm:block font-bold">Profile Details</span>
        </NavLink>
      </nav>
      <div
        onClick={() => navigate("/preview")}
        className="p-3 cursor-pointer sm:px-5 border-[1.5px] border-purple600 rounded-lg"
      >
        <svg
        ...
        <span className="hidden sm:block text-purple600 font-bold">
          Preview
        </span>
      </div>
    </header>
